import { pgTable, text, serial, integer, real, jsonb, varchar, timestamp, boolean, index } from "drizzle-orm/pg-core";
...
export const content = pgTable("content", {
  ...
  type: text("type", { enum: ["movie", "series"] }).notNull().default("movie"),
...
export const apiUsage = pgTable("api_usage", {
  ...
  index("idx_api_usage_month").on(table.month),
]);
