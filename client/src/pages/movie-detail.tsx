        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          ...
          <div className="flex-shrink-0">
            <div className="relative">
              <img 
                src={posterError || !movie.posterUrl || movie.posterUrl.trim() === '' 
              ...
              <div className="flex flex-wrap gap-2">
                {movie.subgenres && movie.subgenres.length > 0 ? (
                  movie.subgenres.map((subgenre, index) => (
                    <span key={index} className="inline-block blood-red-bg text-white px-3 py-1 rounded-full text-sm font-medium">
