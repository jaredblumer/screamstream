        ...
        <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
          ...
          <DialogContent className="horror-bg border-gray-700 text-white">
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="platformKey" className="text-white">
                  Platform Key
                </Label>
                <Input
                  id="platformKey"
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, platformKey: e.target.value }))
                  }
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    onClick={() => {
                      if (
                        window.confirm(
                          `Are you sure you want to delete the ${image.platformName} platform image?`
                        )
                      ) {
...
export default function Admin() {
  ...
  const handleSubmit = () => {
    const submitData: InsertContent = {
      ...formData,
      subgenre:
        formData.primarySubgenre || (formData.subgenres.length > 0 ? formData.subgenres[0] : ''), // Use primary subgenre for browse display
              ...
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({
                          ...prev,
                          criticsRating: Math.round(parseFloat(e.target.value) * 10) / 10,
                        }))
                      }
                      className="horror-bg border-gray-700 text-white"
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData((prev) => ({
                          ...prev,
                          usersRating: Math.round(parseFloat(e.target.value) * 10) / 10,
                        }))
                      }
                      className="horror-bg border-gray-700 text-white"
                    />
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Selected:{' '}
                    {formData.subgenres.length > 0 ? formData.subgenres.join(', ') : 'None'}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData((prev) => ({ ...prev, primarySubgenre: value }))
                    }
                  >
                    <SelectTrigger className="horror-bg border-gray-700 text-white horror-select-trigger">
                      <SelectValue
                    ...
                    <SelectContent className="horror-bg border-gray-700 horror-select-content">
                      {formData.subgenres.map((genre) => (
                        <SelectItem key={genre} value={genre} className="horror-select-item">
                          {genre}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    This subgenre will be displayed on browse pages. All selected subgenres will
                    appear on the movie detail page.
                  </p>
                </div>
                        ...
                        onClick={async () => {
                          try {
                            ...
                            if (response.ok) {
                              ...
                              toast({
                                title: 'Success',
                                description: 'Poster URL updated with TVDB image',
                              });
                            } else {
                              toast({
                                title: 'Error',
                                description: 'Could not find TVDB poster for this title',
                                variant: 'destructive',
                              });
                            }
                          } catch (error) {
                ...
                {formData.platforms.length > 0 && (
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-2">
                      Add streaming links for each selected platform
                    </p>
                    <div className="space-y-2">
