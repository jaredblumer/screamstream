  ...
  const handleViewTopRated = () => {
    ...
    setTimeout(() => {
      ...
      if (filterSection) {
        ...
        const targetPosition = filterSection.getBoundingClientRect().top + window.pageYOffset - headerHeight;
        window.scrollTo({ 
          top: targetPosition, 
          behavior: 'smooth' 
        });
    ...
    <div className="min-h-screen horror-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`transition-all duration-700 ease-in-out overflow-hidden ${
          ...
          <div className={`py-12 sm:py-16 mt-6 sm:mt-0 transition-opacity duration-300 ${
            ...
            <div className="mb-8 animate-slide-up">
              ...
              <p className="text-gray-300">
                Found horror movies matching your search
              </p>
            </div>
