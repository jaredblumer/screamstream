  ...
  <SelectPrimitive.Trigger
    ...
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-md border ' +
        ...
        'hover:bg-white/5 hover:border-[color:var(--maroon-primary)]/70',
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Content
      ...
      className={cn(
        'relative z-50 max-h-[--radix-select-content-available-height] ' +
          ...
          '[&_[data-radix-collection-item]]:!cursor-pointer ' +
          '[&_[data-radix-collection-item]:hover]:bg-white/10 ' +
          '[&_[data-radix-collection-item][data-highlighted]]:bg-white/10 ' +
          '[&_[data-radix-collection-item][data-highlighted]]:text-white',
        position === 'popper' &&
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      'relative flex w-full !cursor-pointer select-none items-center ' +
        ...
        'hover:bg-white/10 focus:bg-accent focus:text-accent-foreground ' +
