...
export default function HeroSection({ onViewTopRanked, onBrowseGenres, onNewToStreaming }: HeroSectionProps) {
  return (
    <section className="relative min-h-[400px] md:min-h-[500px] lg:min-h-[600px] horror-bg flex items-center">
