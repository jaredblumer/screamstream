...
export default function FeedbackForm({ 
  ...
  const feedbackTypes = [
    { value: "technical", label: "Technical Issue", icon: Bug, description: "Bugs, errors, or site functionality problems" },
    { value: "data_error", label: "Incorrect Data", icon: AlertTriangle, description: "Wrong movie info, ratings, or platform availability" },
    { value: "broken_link", label: "Broken Link", icon: Link, description: "Dead links, missing images, or inaccessible content" },
    { value: "content_request", label: "Content Request", icon: Plus, description: "Request missing movies or series to be added" },
    { value: "other", label: "Other", icon: MessageSquare, description: "General feedback or suggestions" }
  ];

  const categoryOptions: Record<string, string[]> = {
    technical: ["Login Issues", "Page Loading", "Search Problems", "Filter Errors", "Mobile Issues"],
    data_error: ["Wrong Year", "Incorrect Rating", "Missing Platform", "Wrong Subgenre", "Description Error"],
      ...
      <DialogContent className="horror-bg border-gray-700 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-400">
            Help us improve Scream Stream by reporting technical issues, data errors, or suggesting improvements.
          </DialogDescription>
        </DialogHeader>
