...
export function WatchmodeGenres() {
  ...
  const { data: response, isLoading, error, refetch } = useQuery<WatchmodeGenresResponse>({
      ...
      <Card className="horror-bg border-gray-700">
        <CardHeader>
          ...
          <CardDescription className="text-gray-400">
            Official genre list from Watchmode API. Use these genre IDs for content filtering and sync operations.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
      ...
      <Card className="horror-bg border-gray-700">
        ...
        <CardContent>
          <p className="text-xs text-gray-400">
            The Horror genre has ID <strong className="text-red-400">11</strong>. This is used in content sync operations to filter for horror titles.
          </p>
        </CardContent>
      </Card>
    </div>
